...
def test_get_destination_config_default_takes_priority_over_cwd(fake_home, tmp_path, monkeypatch):
...
def test_get_destination_priority_cascade_config_wins_over_cwd(fake_home, tmp_path, monkeypatch):
